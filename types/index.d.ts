...
interface HelloCamera {
     ...
     * @param helloCameraSuccess Success callback, that get the image
     * as a base64-encoded String, or as the URI for the image file.
     * @param helloCameraError Error callback, that get an error message.
     * @param helloCameraOptions Optional parameters to customize the camera settings.
     */
    getPicture(
        helloCameraSuccess: (data: string) => void,
        helloCameraError: (message: string) => void,
        helloCameraOptions?: HelloCameraOptions): void;
}

interface HelloCameraOptions {
 ...
 */
interface HelloCameraPopoverOptions {
    x: number;
    y: number;
    width: number;
    height: number;
...
declare class HelloCameraPopoverOptions implements HelloCameraPopoverOptions {
    constructor(x?: number, y?: number, width?: number, height?: number, arrowDir?: number);
}

declare var HelloCamera: {
